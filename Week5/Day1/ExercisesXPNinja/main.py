...
class Phone:
    def __init__(self, phone_number,other_phone) -> None:
        self.phone_number = phone_number
        self.other_phone = other_phone
        self.messages = []
        self.call_history = []
    def call (self):
        pair = "f{phone_number} called {other_phone}"
        self.call_history.append(pair)
    def show_call_history(self):
        print(self.call_history)
    def send_message(self):
        self.messages.append(f'to: {self.other_phone} from: {self.phone_number} content:   )
